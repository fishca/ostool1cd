...
namespace _1STool1CD
{
    ...
    public class FieldType
    {
        ...
        public virtual bool get_binary_value(char[] buf, String value) { return true; }

        public virtual String get_XML_presentation(char[] rec, Table parent, bool ignore_showGUID) { return " "; }

        public virtual UInt32 getSortKey(char[] rec, char[] SortKey, Int32 maxlen) { return 0; }
